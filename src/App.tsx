...
const ONBOARDING_STEPS = [
  {
    ...
    description:
      "Your all-in-one expense tracker built for Filipino freelancers.",
    tip: "You can replay this guide anytime from the Help button.",
  ...
  },
  {
    ...
    description: "Projects represent your clients or ongoing work.",
    tip: "Name projects clearly, like 'Website Redesign - Acme Corp'.",
  ...
  },
  {
    ...
    description: "Record every business expense you make.",
    tip: "Log expenses right after spending to avoid forgetting.",
  ...
  },
  {
    ...
    description: "Share expenses across multiple projects!",
    tip: "Use the Auto button to split equally, or set custom percentages.",
  ...
  },
  {
    ...
    description: "Watch your estimated tax savings grow automatically.",
    tip: "Confirm your actual tax rate with a licensed CPA.",
  ...
  },
  {
    ...
    tip: "Save your reports alongside physical receipts.",
  ...
  },
  {
    ...
    description: "Start tracking your expenses and save money on taxes.",
    tip: "Upgrade to Pro for unlimited expenses and premium features.",
...
const LandingPage = ({ onLogin }) => {
  ...
  const faqs = [
    {
      ...
      a: "Yes — 100%. Each account sees only its own data protected with row-level security. No one else can see your financials.",
    },
    {
      q: "Is this actually BIR-compliant?",
      a: "FreelanceFunds generates a clear, itemized breakdown by project and category that your accountant can use. Always confirm with a licensed CPA.",
    },
    {
      q: "Can I cancel anytime?",
      a: "Absolutely. Cancel your Pro subscription at any time with one click. You keep Pro features until the end of your billing period.",
    },
    {
    ...
    },
    {
      ...
      a: "Your data stays safe. You'll just be limited to 50 expenses and 3 projects going forward.",
    },
    {
      q: "Does it work on mobile?",
      a: "Yes — fully responsive. The app works on mobile browsers and is actively being improved.",
    },
    {
  ...
  const testimonials = [
    {
      stars: 5,
      text: '"The dashboard is clean and shows total tracked expenses with useful insights like estimated tax savings."',
      name: "Maria C.",
    ...
    {
      stars: 5,
      text: '"Streamlines daily expense tracking effectively. Clean, intuitive, with strong UX execution."',
      name: "Jerick P.",
    ...
    {
      stars: 5,
      text: '"Genuinely useful for Filipino freelancers. Sleek design with a modern dark theme."',
      name: "Raine B.",
  ...
  const features = [
    {
      icon: "⚡",
      title: "Smart Split",
      desc: "Allocate one expense across multiple clients automatically.",
    },
    {
      icon: "📊",
      title: "BIR-Ready Reports",
      desc: "Export clean CSVs your accountant can use directly.",
    },
    {
      icon: "💰",
      title: "Tax Savings Tracker",
      desc: "See your estimated deductions grow in real time.",
    },
    {
      icon: "📁",
      title: "Project Budgets",
      desc: "Set budgets and get alerts before you overspend.",
    },
    {
      icon: "📱",
      title: "Mobile-First",
      desc: "Track on the go — works perfectly on any screen.",
    },
    {
      icon: "🔒",
      title: "Private & Secure",
      desc: "Your data is encrypted and visible only to you.",
    },
  ];
    ...
    >
      ...
      <div
        style={{
          ...
          padding: isMobile ? "68px 16px 14px" : "70px 24px 14px",
          textAlign: "center",
          color: "#fff",
        }}
      >
        ...
        >
          ...
          <p style={{ fontSize: isMobile ? 12 : 14, fontWeight: 600 }}>
            🔥 <strong>Launch Promo:</strong> Get full Pro for just{" "}
            <strong>₱150</strong> — 7 days only.
          </p>
        </div>
      </div>
      ...
      <section
        style={{
          ...
          alignItems: "center",
          justifyContent: "center",
          padding: isMobile ? "60px 16px 60px" : "80px 24px 80px",
          textAlign: "center",
          position: "relative",
          overflow: "hidden",
        }}
      >
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(ellipse 70% 50% at 50% 0%, rgba(249,115,22,.07) 0%, transparent 60%)",
          }}
        />
        <div
          className="lp-fade"
        ...
        <div className="ticker-inner">
          {[
            ...[
              ...
              "BIR quarterly report ✓",
              "Phone bill across 3 clients ✓",
              "Grab rides per project ✓",
              "₱18,000 avg annual savings ✓",
              "10 hours saved monthly ✓",
              "8 of 9 testers use it daily ✓",
            ],
            ...[
              "Adobe CC split 60/40 ✓",
              "BIR quarterly report ✓",
          ...
          >
            {features.map((f, i) => (
              ...
              >
                ...
                <p
                  style={{ fontSize: 13.5, color: "#6b6460", lineHeight: 1.75 }}
                >
                  {f.desc}
                </p>
              </div>
          ...
          >
            {[
              ...
              <div
                key={i}
                style={{
                  background: i === 1 ? "#111" : "#faf8f4",
                  border:
                    i === 1
                      ? "2px solid rgba(249,115,22,.4)"
                      : "1px solid #e8e4de",
                  borderRadius: 24,
              ...
              >
                ...
                <button
                  ...
                  style={{
                    width: "100%",
                    background: plan.ghost ? "transparent" : "#f97316",
                    color: plan.ghost ? "#444" : "#fff",
                    border: plan.ghost ? "1.5px solid #e8e4de" : "none",
                    borderRadius: 12,
                    padding: "12px 20px",
                    fontSize: 14,
                    fontWeight: 700,
    ...
    >
      ...
      <div
        style={{
          width: "100%",
          maxWidth: 420,
          animation: "authUp .4s cubic-bezier(.16,1,.3,1) both",
        }}
      >
        {/* Logo */}
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 13, color: "#555" }}>
            Expense tracking for Filipino freelancers
          </p>
        </div>
...
const Dashboard = ({ user, signOut }) => {
  ...
  const isPro = plan === "pro",
    maxExp = isPro ? Infinity : FREE_EXP,
    maxProj = isPro ? Infinity : FREE_PROJ;
  const D = dark;
  ...
  const completeOnboarding = () => {
    ...
    showToast("Welcome! Start by creating your first project.");
  };
  const handleOnboardingNext = () => {
    if (onboardingStep === ONBOARDING_STEPS.length - 1) completeOnboarding();
  ...
  const saveExpense = () => {
    ...
    setTimeout(() => {
      if (editId) {
        ...
        setExpenses((prev) => [
          { ...form, id: "e" + Date.now(), amount: Number(form.amount) },
          ...prev,
        ]);
  ...
  const saveProject = () => {
    ...
    if (projects.length >= maxProj) {
      showToast("Upgrade to add more projects", "warning");
      setShowPlan(true);
      setModal(null);
      return;
    }
    setSaving(true);
    setTimeout(() => {
      setProjects((prev) => [...prev, { ...pForm, id: "p" + Date.now() }]);
  ...
  const styles = `
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    D ? "#888" : "#374151"
  };border:none;border-radius:10px;padding:9px 15px;font-family:inherit;font-size:13px;font-weight:700;cursor:pointer;transition:all .15s;display:inline-flex;align-items:center;gap:6px}
    .btn-ghost:hover{background:${D ? "#282828" : "#e5e7eb"}}
    .input{width:100%;border:1.5px solid ${brd};border-radius:10px;padding:10px 14px;font-family:inherit;font-size:14px;outline:none;background:${
    D ? "#1f1f1f" : "#fff"
  };color:${txt};transition:border .15s}
    ...
    isMobile ? "100%" : "520px"
  };max-height:92vh;overflow-y:auto;border:1px solid ${brd}}
    ...
    .nav-btn:hover{background:${
      D ? "rgba(249,115,22,.08)" : "rgba(249,115,22,.05)"
    }}
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        <p
                          style={{ fontWeight: 600, fontSize: 13, color: txt }}
                        >
                          {e.description}
                        </p>
  ...
  const renderExpenses = () => (
    <div>
      ...
      {sorted.length === 0 ? (
        <div
          style={{ textAlign: "center", padding: "40px 20px", color: muted }}
        >
  ...
  const renderReports = () => (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div className="card" style={{ padding: 24 }}>
        ...
        >
          {[
            ["Total Expenses", fmt(grandTotal), "#f97316"],
            ["Est. Tax Savings", fmt(estSavings), "#10b981"],
            ["Expense Count", expenses.length, "#3b82f6"],
            ...
            return (
              <div key={cat} style={{ marginBottom: 14 }}>
                ...
                <div className="prog">
                  <div
                    className="prog-bar"
                    style={{ width: `${pct}%`, background: cClr }}
                  />
                </div>
              </div>
            );
      ...
      <div className="card" style={{ padding: 24 }}>
        <h3
          style={{ fontWeight: 700, fontSize: 16, color: txt, marginBottom: 8 }}
        >
          Export
        </h3>
        <p style={{ fontSize: 13, color: muted, marginBottom: 16 }}>
          Download a CSV file suitable for your accountant's BIR filing.
        </p>
        <button
          className="btn-primary"
          onClick={exportCSV}
  ...
  const Sidebar = () => (
    ...
    >
      ...
      <div
        style={{
          padding: collapsed ? "12px 6px" : "16px",
      ...
      {modal === "expense" && (
        <div className="overlay">
          <div className="modal">
            ...
            >
              <h3 style={{ fontWeight: 700, fontSize: 18, color: txt }}>
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              >
                ...
                <div style={{ display: "flex", gap: 6 }}>
                  ...
                  {form.splits.length < (isPro ? 4 : 2) &&
                    projects.length > form.splits.length && (
                      <button
                        onClick={() =>
                          setForm((f) => ({
                            ...f,
                            splits: [...f.splits, { pid: "", pct: 0 }],
                          }))
                        }
                        className="btn-ghost"
                        style={{ fontSize: 11, padding: "4px 10px" }}
              ...
              {form.splits.map((s, i) => (
                ...
                >
                  <select
                    ...
                    value={s.pid}
                    onChange={(e) => {
                      const arr = [...form.splits];
                      arr[i] = { ...arr[i], pid: e.target.value };
                      setForm((f) => ({ ...f, splits: arr }));
                    }}
                  >
                  ...
                  <input
                    className="input"
                    type="number"
                    style={{ width: 64, padding: "7px 10px" }}
                    value={s.pct}
                    onChange={(e) => {
                      const arr = [...form.splits];
            ...
            <textarea
              className="input"
              style={{ marginBottom: 20, resize: "vertical", minHeight: 60 }}
        ...
        <div className="overlay">
          <div className="modal" style={{ maxWidth: 400 }}>
            ...
            <input
              ...
              value={pForm.budget}
              onChange={(e) =>
                setPForm((f) => ({ ...f, budget: Number(e.target.value) }))
              }
            />
                  ...
                  style={{
                    ...
                    outline:
                      pForm.color === c
                        ...
                        : "none",
                    outlineOffset: 2,
                    transform: pForm.color === c ? "scale(1.15)" : "scale(1)",
                    transition: "all .15s",
                  }}
                />
              ))}
        ...
        <div className="overlay">
          <div className="modal" style={{ maxWidth: 400 }}>
            ...
            <div
              style={{
                background: D
                  ? "linear-gradient(135deg,#1a0e00,#111)"
                  : "#fff7ed",
            ...
            >
              ...
              >
                ₱500<span style={{ fontSize: 14, color: muted }}>/month</span>
              </p>
              <p style={{ fontSize: 12, color: "#f97316", fontWeight: 700 }}>
                🔥 Launch promo: ₱150 for first 7 days
              </p>
            </div>
            {[
              "Unlimited expenses & projects",
              "4-way expense splitting",
        ...
        <div className="overlay">
          <div className="modal" style={{ maxWidth: 480 }}>
            ...
            {[
              [
                "1. Create a project",
                "Go to Projects → click New Project. Give it a name, a client, and an optional budget.",
              ],
              [
                "2. Log an expense",
                "Click Add Expense. Fill in the description, amount, category, and date.",
              ],
              [
                "3. Split across projects",
                "In the expense form, use the Project Split section. Click + Add to split across multiple projects. Percentages must total 100%.",
              ],
              [
                "4. View your dashboard",
                "The Dashboard shows your total tracked expenses, estimated tax savings, monthly spending chart, and recent activity.",
              ],
              [
                "5. Export for BIR",
                "Go to Reports → Export CSV. Send this file to your accountant.",
              ],
            ].map(([title, body], i) => (
              <div
                key={i}
                style={{
                  marginBottom: 16,
                  paddingBottom: 16,
                  borderBottom: i < 4 ? `1px solid ${brd}` : "none",
                }}
              >
                <p
                  style={{
